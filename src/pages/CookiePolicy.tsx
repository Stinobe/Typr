...
const CookiePolicy: FunctionComponent = () => (
  <div>
    <h1>Cookie Policy for Typr by Stino</h1>

    <p>This is the Cookie Policy for Typr by Stino, accessible from https://typr.bystino.com</p>
