...
const PrivacyPolicy: FunctionComponent = () => (
  <div>
    <h1>Privacy Policy for Typr by Stino</h1>

    <p>
      At Typr by Stino, accessible from https://typr.bystino.com, one of our main priorities is the
      privacy of our visitors. This Privacy Policy document contains types of information that is
      collected and recorded by Typr by Stino and how we use it.
    </p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in Typr by Stino. This
    ...
    <p>
      Typr by Stino follows a standard procedure of using log files. These files log visitors when
    ...
    <p>
      Like any other website, Typr by Stino uses 'cookies'. These cookies are used to store
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on Typr by
      Stino, which are sent directly to users' browser. They automatically receive your IP address
    ...
    <p>
      Note that Typr by Stino has no access to or control over these cookies that are used by
    ...
    <p>
      Typr by Stino's Privacy Policy does not apply to other advertisers or websites. Thus, we are
    ...
    <p>
      Typr by Stino does not knowingly collect any Personal Identifiable Information from children
